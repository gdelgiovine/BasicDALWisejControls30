...
Public Class DataNavigator
    ...
    Public Property FindKey() As Keys
        Get
            Return _FindKey
        End Get
    ...
    Public Property UndoFKey() As Keys
        Get
            Return _UndoFKey
        End Get
        Set(ByVal value As Keys)
    ...
    Public Property AddNewFKey() As Keys
        Get
            Return _AddNewFKey
        End Get
        Set(ByVal value As Keys)
    ...
    Public Function DataGrid_Update(ByRef DataGridView As Wisej.Web.DataGridView) As Integer
        ...
        If DataGridView IsNot Nothing And DataGridView.DataSource IsNot Nothing And DataGridView.CurrentRow IsNot Nothing Then
            ...
            Try
                ...
                Catch ex As Exception
                End Try
                AffectedRecords = Me._DbObject.UpdateFromDataTable(dt)
                dt = Me._DbObject.DataTable
    ...
    Public Function DataGrid_Delete(ByVal DataGridView As Wisej.Web.DataGridView) As Integer
        ...
        If DataGridView.DataSource IsNot Nothing Then
            ...
            If DataGridView.CurrentRow IsNot Nothing Then
                RowIndex = DataGridView.CurrentRow.Index
                If DataGridView.CurrentRow.IsNewRow = False Then
            ...
            Dim xRec As Integer = 1
            'xRec = _DbObject.UpdateFromDataTable(dt)
            'xRec = _DbObject.DeleteFromDataTable(dt)
            ...
            Select Case Me.DataGridActive
                Case False
                    If Me._DbObject IsNot Nothing Then
                        _AddNewPending = Me._DbObject.AddNewStatus
                        AddNewPending = _AddNewPending
                    End If

                Case Else
                    If Me.DataGrid IsNot Nothing Then
                        AddNewPending = _AddNewPending
                    End If
            End Select
    ...
    Property AddNewCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bNew.Text = ButtonCaption(value, _AddNewFKey)
        End Set
    End Property
    ...
    Property FindCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bFind.Text = ButtonCaption(value, _FindKey)
        End Set
    End Property
    Property CloseCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bClose.Text = ButtonCaption(value, _CloseFKey)
        End Set
    End Property
    ...
    Property PrintCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bPrint.Text = ButtonCaption(value, _PrintFKey)
        End Set
    End Property
    ...
    Property DeleteCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bDelete.Text = ButtonCaption(value, _DeleteFKey)
        End Set
    ...
    Property SaveCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bSave.Text = ButtonCaption(value, _SaveFKey)
        End Set
    End Property
    ...
    Property RefreshCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bRefresh.Text = ButtonCaption(value, _RefreshFKey)
        End Set
    End Property
    ...
    Property UndoCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bUndo.Text = ButtonCaption(value, _UndoFKey)
        End Set
    End Property
    Property MovePreviousCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bPrev.Text = ButtonCaption(value, _MovePreviousFKey)
        End Set
    End Property
    Property MoveNextCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bNext.Text = ButtonCaption(value, _MoveNextFKey)
        End Set
    End Property
    Property MoveLastCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bLast.Text = ButtonCaption(value, _MoveLastFKey)
        End Set
    End Property
    Property MoveFirstCaption() As String
        ...
        Set(ByVal value As String)
            ...
            Me.bFirst.Text = ButtonCaption(value, _MoveLastFKey)
        End Set
    End Property
    ...
    Private Sub Save()
        ...
        If Me.DataGridListView IsNot Nothing Then
            Me.DataGridListView.DataSource = Me._DbObject.DataTable
        End If
    ...
    Public Sub New()
        ...
        Me.ToolBar.Dock = DockStyle.Fill
    ...
    Public Sub UpdateRecordLabel()
        ...
        If Me._DbObject IsNot Nothing And Me.RecordLabel.Visible = True Then
            ...
            'Dim _sep As String = "<p style='margin-top:0px;line-height:1.0;text-align:center;'>{0}<br>{1}<br>{2}</p>"
            Dim _sep As String = "<p style='line-height:1.0;text-align:center;'>{0}<br>{1}<br>{2}</p>"

            Select Case Me._DataGridActive
                Case Is = False

                    If Me._DbObject.AddNewStatus = False Then
                        'Me.RecordLabel.Text = Me._DbObject.CurrentPosition + 1 & Me._RecordLabelSeparator & Me._DbObject.RowCount
                        Me.RecordLabel.Text = String.Format(_sep, Me._DbObject.CurrentPosition + 1, Me._RecordLabelSeparator, Me._DbObject.RowCount)
                    Else
                        Me.RecordLabel.Text = "New Row"
                    End If

                Case Is = True
                    Try
                        If Me.DataGrid.CurrentRow IsNot Nothing Then
                            'Me.RecordLabel.Text = Me.DataGrid.CurrentRow.Index + 1 & _RecordLabelSeparator & Me.DataGrid.RowCount
                            If Me._AddNewPending = False Then
                                Me.RecordLabel.Text = String.Format(_sep, Me.DataGrid.CurrentRow.Index + 1, Me._RecordLabelSeparator, Me.DataGrid.RowCount)
                            Else
                                'Me.RecordLabel.Text = "0" & _RecordLabelSeparator & "0"
                                Me.RecordLabel.Text = "New Row"
                            End If
                        Else
                            Me.RecordLabel.Text = String.Format(_sep, 0, Me._RecordLabelSeparator, 0)
                        End If
    ...
    Private Sub _mDBObject_DataEventAfter(ByVal EventType As BasicDAL.DataEventType) Handles _DbObject.DataEventAfter
        ...
        Select Case EventType
            ...
            Case BasicDAL.DataEventType.Delete, BasicDAL.DataEventType.DeleteAll
                SetDataNavigator()
            Case BasicDAL.DataEventType.DeleteFromDataSet, BasicDAL.DataEventType.DeleteFromDataTable
                SetDataNavigator()
            Case BasicDAL.DataEventType.Disposing
            Case BasicDAL.DataEventType.Initializing
            Case BasicDAL.DataEventType.Insert
                SetDataNavigator()
            Case BasicDAL.DataEventType.MoveFirst, BasicDAL.DataEventType.MoveLast, BasicDAL.DataEventType.MoveNext, BasicDAL.DataEventType.MovePrevious, BasicDAL.DataEventType.MoveTo
                SetDataNavigator()
            Case BasicDAL.DataEventType.Query
                Me.DataGridListViewInit()
            Case BasicDAL.DataEventType.UndoChanges
                SetDataNavigator()
            Case BasicDAL.DataEventType.Update, BasicDAL.DataEventType.UpdateFromDataSet, BasicDAL.DataEventType.UpdateFromDataTable
                SetDataNavigator()
                'Me._AddNewPending = True
            Case Else
                'Me._AddNewPending = False
    ...
    Public Sub SetDataNavigator()
        ...
        Me.Accelerators = New Wisej.Web.Keys() {_MoveFirstFKey, _MoveLastFKey, _MoveNextFKey, _MovePreviousFKey, _AddNewFKey, _DeleteFKey, _RefreshFKey, _FindKey, _UndoFKey, _SaveFKey, _CloseFKey}
    ...
    Private Sub DataNavigator_Accelerator(sender As Object, e As AcceleratorEventArgs)
