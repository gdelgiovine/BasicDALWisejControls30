...
Public Class QBEForm
    ...
    Public ParametersLoaded As Boolean = False
    Private mResultGridFont As System.Drawing.Font
    ...
    Dim _sep As String = "<p style='margin-top:2px;line-height:1.0;text-align:center;'>{0}<br>{1}<br>{2}</p>"
    ...
    Private _FindFKey As Keys = Keys.F4
    Private _PrintFKey As Keys = Keys.F11
    Private _FKeyEnabled As Boolean = False


    Private _RecordLabelSeparator As String = "of"

    Public Property RecordLabelSeparator() As String
        Get
    ...
    Public Property FKeyEnabled() As Boolean
        Get
            Return _FKeyEnabled
        End Get
        Set(ByVal value As Boolean)
            _FKeyEnabled = value
            Me.UpdateButtonsCaption()
        End Set
    End Property
    Public Sub UpdateButtonsCaption()
    ...
    End Sub
    Public Property PrintFKey() As Keys
        Get
            Return _PrintFKey
        End Get
    ...
    Public Property CloseFKey() As Keys
        Get
            Return _CloseFKey
        End Get
        Set(ByVal value As Keys)
    ...
    Public Property RefreshFKey() As Keys
        Get
            Return _RefreshFKey
        End Get
        Set(ByVal value As Keys)
    ...
    Public Property SaveFKey() As Keys
        Get
            Return _SaveFKey
        End Get
        Set(ByVal value As Keys)
    ...
    Public Property DeleteFKey() As Keys
        Get
            Return _DeleteFKey
        End Get
        Set(ByVal value As Keys)
    ...
    Public Property MovePreviousFKey() As Keys
        Get
    ...
    Public Property MoveNextFKey() As Keys
        Get
    ...
    Public Property MoveFirstFKey() As Keys
        Get
    ...
    Public Property MoveLastFKey() As Keys
        Get
    ...
    Property ResultGridFont() As System.Drawing.Font
        Get
            Return mResultGridFont
        End Get
        Set(ByVal value As System.Drawing.Font)
            If value IsNot Nothing Then
                Me.mResultGridFont = value
                Me.ResultGrid.Font = value
            End If
    ...
    End Property
    Private _MoveFirstCaption As String
    ...
    Property MoveFirstCaption() As String
        ...
        Set(ByVal value As String)
            ...
            bFirst.Text = ButtonCaption(value, _MoveFirstFKey)
        End Set
    ...
    Property MoveFirstToolTipText() As String
        ...
        End Set
    End Property
    Private _MoveLastCaption As String
    Property MoveLastCaption() As String
        ...
        Set(ByVal value As String)
            ...
            bLast.Text = ButtonCaption(value, _MoveLastFKey)
        End Set
    End Property
    Property MoveLastToolTipText() As String
        ...
        End Set
    End Property
    Private _MovePreviousCaption As String
    Property MovePreviousCaption() As String
        ...
        Set(ByVal value As String)
            ...
            bPrev.Text = ButtonCaption(value, _MovePreviousFKey)
        End Set
    End Property
    Property MovePreviousToolTipText() As String
        ...
        End Set
    End Property
    Private _MoveNextCaption As String
    Property MoveNextCaption() As String
        ...
        Set(ByVal value As String)
            ...
            bNext.Text = ButtonCaption(value, _MoveNextFKey)
        End Set
    End Property
    ...
    Private _RefreshCaption As String
    Property RefreshCaption() As String
        ...
        Set(ByVal value As String)
            ...
            bRefresh.Text = ButtonCaption(value, _RefreshFKey)
        End Set
    End Property
    ...
    Private _DeleteFiltersCaption As String
    Property DeleteFiltersCaption() As String
        ...
        Set(ByVal value As String)
            ...
            bDelete.Text = ButtonCaption(value, _DeleteFKey)
        End Set
    End Property

    Private Function ButtonCaption(ByVal ButtonText As String, ByVal FKey As Keys)
        If Me._FKeyEnabled Then
            Dim _f As String = FKey.ToString().Replace(",", "+")
            _f = _f.Replace(" ", "")
    ...
    Private _PrintCaption As String
    Property PrintCaption() As String
        ...
        Set(ByVal value As String)
            _PrintCaption = value
            bPrint.Text = ButtonCaption(value, _PrintFKey)
    ...
    Property PrintToolTipText() As String
        ...
        End Set
    End Property
    Private _SelectCaption As String
    Property SelectCaption() As String
        ...
        Set(ByVal value As String)
            ...
            bSave.Text = ButtonCaption(value, _SaveFKey)
        End Set
    End Property
    Property SelectToolTipText() As String
        ...
        End Set
    End Property
    Private _CloseCaption As String
    Property CloseCaption() As String
        ...
        Set(ByVal value As String)
            _CloseCaption = value
            bClose.Text = ButtonCaption(value, _CloseFKey)
        End Set
    End Property
    ...
    Public Property QBEColumns() As QBEColumns
        Get
    ...
    Private Sub CalcolaSplitterDistance()
    ...
    Public Sub ShowQBE(Optional ByVal CallerForm As Form = Nothing, Optional ByVal Modal As Boolean = False)

        Dim x As Integer = 0

        Me.Accelerators = New Wisej.Web.Keys() {_MoveFirstFKey, _MoveLastFKey, _MoveNextFKey, _MovePreviousFKey, _DeleteFKey, _RefreshFKey, _SaveFKey, _CloseFKey}
        ...
        If Me.ParametersLoaded = False Then
            Me.LoadParameters()
        End If
        ...
        Try
            ...
            Select Case Me.mReportViewerMode
                ...
                Case ReportViewerMode.PDFUrl
                    ...
                    Dim PDFViewerFileName = LocalReportTempDir & "\" & BasicDAL.Utilities.FileHelper.GetSafeFileName(Report.ReportTitle & ".pdf")
                    ...
                    Dim PDFViewerFileNameURL = BasicDAL.Utilities.GetURLWithoutFileName(Application.Url) & ReportsPDFUrlPath & "/" & Web.HttpUtility.HtmlEncode(BasicDAL.Utilities.FileHelper.GetFileName(PDFViewerFileName))
    ...
    Private Function OrderByRules() As String
        ...
        For Each Col As QBEColumn In Me.QBEColumns
            ...
            If Col.DisplayInQBEResult And Col.DbCOlumn.IsPrimaryKey() = True Then
                OrderBy = OrderBy & Col.DbCOlumn.DbColumnName & ", "
            End If
        Next
                ...
                Else
                    ...
                    If _QBEColumn.DisplayInQBEResult = True Then
                        ...
                        With Me.ResultGrid.Columns(x)
                            ...
                            charw = 8
                            Select Case _QBEColumn.DbCOlumn.DbType
                                Case Is = DbType.Date, DbType.DateTime, DbType.Time
                                    Select Case _QBEColumn.ColumnWidth
                                        Case > 0
                                            .Width = _QBEColumn.ColumnWidth
                                            .AutoSizeMode = DataGridViewAutoSizeColumnsMode.None
                                        Case = -2
                                            .AutoSizeMode = DataGridViewAutoSizeColumnsMode.Fill
                                        Case -1
                                ...
                                Case Is = DbType.Byte, DbType.Currency, DbType.Decimal, DbType.Double _
                            ...
                            With .DefaultCellStyle
                                ...
                                End If
                                If _QBEColumn.Font IsNot Nothing Then
                                    .Font = _QBEColumn.Font
                                End If

                                If (.Font Is Nothing) Then
                                    .Font = Me.ResultGrid.Font.Clone
                                End If
                                .Font = .Font.Change(_QBEColumn.FontStyle)
                    ...
                    End If
                End If
                '_QBEColumn.ResultDataGridViewColumn = Me.ResultGrid.Columns(x)
            End If
            ...
            If i >= 0 Then
                ...
                If Trim(Value) <> "" Or Value <> Nothing Then
                    ...
                    If Filters IsNot Nothing Then
                        ...
                        Filters(Filters.Count - 1).LogicOperator = BasicDAL.LogicOperator.None
        ...
        For Each Element In FilterConditions
            ...
            If Element <> "" Then
                ...
                With Filter
                    ...
                    Else
                        .ComparisionOperator = BasicDAL.ComparisionOperator.Equal
                    End If
    ...
    Private Sub ReturnSelectedRows()
        ...
        Else
            For Each Dbcolumn As BasicDAL.DbColumn In Me.QueryDbObject.GetPrimaryKeyDbColumns
                If (Dbcolumn.DbColumnNameE.Contains(" ")) Then
    ...
    Public Sub New()
        ...
        End Try
        Me.mResultGridFont = Me.ResultGrid.Font
        Me.QBEColumns.QBEForm = Me
        Me.ResultGrid.AutoGenerateColumns = False
    ...
    Private Sub ResultGrid_CellEnter(sender As Object, e As DataGridViewCellEventArgs) Handles ResultGrid.CellEnter
        Try
            ...
            Me.RecordLabel.Text = String.Format(Me._sep, Me.ResultGrid.CurrentCell.RowIndex + 1, Me._RecordLabelSeparator, Me.DbObject.RowCount)
        Catch ex As Exception
    ...
    Private Sub LoadQBEUserColumnSet(ByVal FileName As String)
        ...
        BasicDAL.Utilities.SerializationHelper.DeserializeObjectFromFile(FileName, QBEUserColumnsSet)
    ...
    Private Sub btnEsporta_Click(sender As Object, e As EventArgs) Handles btnEsporta.Click
        ...
        Dim exportfilename As String = BasicDAL.Utilities.FileHelper.GetSafeFileName(Me.Text)
    ...
    Private Sub QBEForm_Accelerator(sender As Object, e As AcceleratorEventArgs) Handles MyBase.Accelerator
        Me.HandleUserInput(sender, e)
    End Sub


    Private Sub HandleUserInput(ByVal sender As Object, ByVal e As Object)
        If Me._FKeyEnabled = False Then
            Return
        End If
...
Public Class QBEColumn
    Public QBEForm As QBEForm = Nothing
    ...
    Private mFont As System.Drawing.Font = Nothing
    Private mAlignment As DataGridViewContentAlignment = DataGridViewContentAlignment.TopLeft
    Private mFontStyle As New Drawing.FontStyle

    Property FontStyle() As Drawing.FontStyle
        Get
    ...
    Property Aligment() As DataGridViewContentAlignment
        Get
            Aligment = mAlignment
    ...
    Property OrdinalPosition() As Integer
        Get
            OrdinalPosition = Me.mOrdinalPosition
        End Get
        Set(ByVal value As Integer)
...
Public Class QBEColumns
    ...
    Public Function Add(ByVal DbColumn As BasicDAL.DbColumn, ByVal FriendlyName As String, ByVal DisplayFormat As String, ByVal QBEValue As Object, ByVal UseInQBE As Boolean, ByVal DisplayInQBEResult As Boolean, ByVal QBEColumnType As QBEColumnsTypes, ByVal ColumnWidth As Integer) As QBEColumn
        ...
        With x
            ...
            .Aligment = DataGridViewContentAlignment.TopLeft
            If DbColumn.IsNumeric Or DbColumn.IsDate Then
                .Aligment = DataGridViewContentAlignment.TopRight
            End If
            If DbColumn.IsString Then
                .Aligment = DataGridViewContentAlignment.TopLeft
            End If
            If DbColumn.IsTime Or DbColumn.IsDate Then
                .Aligment = DataGridViewContentAlignment.TopRight
            End If
            If DbColumn.IsBoolean Then
                .Aligment = DataGridViewContentAlignment.MiddleCenter
            End If
        End With
    ...
    Public Function GetItem(ByVal Index As Integer) As QBEColumn
    ...
    Public Function GetItem(ByVal DbColumn As BasicDAL.DbColumn) As QBEColumn

        For Each _QBEColumn As QBEColumn In List
            If _QBEColumn.DbCOlumn.Name = DbColumn.Name Then
                Return _QBEColumn
            End If
        Next
        Return Nothing
    ...
    Public Function GetItem(ByVal Name As String) As QBEColumn

        For Each _QBEColumn As QBEColumn In List
            If _QBEColumn.DbCOlumn.Name = Name Then
                Return _QBEColumn
            End If
        Next
        Return Nothing
    ...
    Public Function GetItemIndex(ByVal QBEColumn As QBEColumn) As Integer
        If List.Contains(QBEColumn) Then
